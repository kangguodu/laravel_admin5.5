  ...
  <div class="login-box-body">
    ...
    <form action="{{ url('auth/login') }}" method="post">
      ...
      <div class="form-group">
        <div class="col-sm-9 form-group" style="padding-left:0">
          <input type="input" class="form-control" placeholder="輸入驗證碼" name="authcode" >
        </div><div class="col-sm-2" style="padding-left:0"><img src="{{url('authimg')}}" id="authimg" alt="" onclick="this.src='{{url('authimg')}}?'+Math.random()"/></div>
      </div>
